        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              SizedBox(width: 100,),
              Text(foodCategory.title.toString(),style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400,fontSize: 16),)
            ],
          ),
            ...
            GestureDetector(
              onTap: (){
                var foodIndex = Get.find<FoodController>()
                    .foodList
                    .indexOf((controller.foodTypeList[index]));
                print(foodIndex);
                          ...
                          children: [
                            ...
                            CircleAvatar(
                              ...
                              backgroundImage: NetworkImage(
                                  AppVariables.BASE_URI + "/uploads/" + controller.foodTypeList[index].thumbnail!),
                            )
                          ],
                        ),
                        SizedBox(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(controller.foodTypeList[index].price!.toString(),
                                    style: TextStyle(
